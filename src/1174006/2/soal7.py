# -*- coding: utf-8 -*-
"""
Created on Tue Oct 22 21:33:53 2019
...
w = shapefile.Writer('soal7', shapeType=shapefile.POLYGON) #membuat object Writer baru dan memberi argumen berupa nama file dari shapefilenya yaitu soal7 dan argumen berupa shapeTypenya yaitu shapefile.POLYGON yang berupa poligon
...
w.poly([[[1,3],[5,3],[1,2],[5,2]]]) #mengisi data poly sesuai koordinatnya masing-masing
