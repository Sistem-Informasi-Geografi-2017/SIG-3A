...
sf = shapefile.Reader("2/soal1") #Digunakan untuk melakukan membaca file shp
...
dir(anu[0]) #Digunakan untuk mengetahui object yang digunakan berdasarkan nomor index 0
...
# In[] Soal 7
import shapefile #Digunakan untuk memanngil library SHP
sf = shapefile.Reader("2/soal6") #Digunakan untuk melakukan membaca file shp
