...
w = shapefile.Writer('soal4', shapefile.POINT) #membuat object Writer baru dan memberi argumen berupa nama file dari shapefilenya yaitu soal4 dan argumen berupa shapeTypenya yaitu shapefile.POINT yang berupa point
