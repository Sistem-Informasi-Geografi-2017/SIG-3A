# -*- coding: utf-8 -*-
"""
Created on Sun Oct 27 12:09:43 2019

@author: ONIWALDUS
"""

import shapefile # Meng-import library shapefile
w = shapefile.Writer('Nomor3', shapeType=1)  # Membuat penggambar pada shapefile yang nantinya akan di namakan nomor3 dan bentuknya itu adalah shapetype 1 yaitu point (titik)
