# -*- coding: utf-8 -*-
"""
Created on Sun Oct 27 12:07:42 2019

@author: ONIWALDUS
"""

import shapefile # Meng-import library shapefile
w = shapefile.Writer('Nomor1', shapeType=1)  # Membuat penggambar pada shapefile yang nantinya akan di namakan nomor1 dan bentuknya itu adalah shapetype 1 yaitu point (titik)
